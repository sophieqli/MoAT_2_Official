sets=("nltcs" "kdd" "plants" "baudio" "jester" \
...
do
    ...
    then
        ...
        CUDA_VISIBLE_DEVICES=1 python3 catipfp_train.py --dataset_path datasets/ \
                --dataset $dataset --device cuda:0 --model MoAT --max_epoch 52 \
